...
// const nameDrug = require('../middleware/name'); //uses the name.js file from middleware here
// const cardDrug = require('../middleware/card'); //uses the card.js file from middleware here
// const packDrug = require('../middleware/pack'); //uses the pack.js file from middleware here
// const perDayDrug = require('../middleware/perDay');
// const dosageDrug = require('../middleware/dosage'); //uses the dosage.js file from middleware here

const validateDrug = require('../middleware/drug'); //uses the drug.js file from middleware here
